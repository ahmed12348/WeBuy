                    ...
                    <div class="row breadcrumbs-top">
                        <div class="breadcrumb-wrapper col-12">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item"><a href="{{route('admin.languages')}}"> المنتجات الرئيسية </a>
                                </li>
                                                            ...
                                                            <div class="col-md-9">
                                                                <div class="form-group">
                                                                    <label for="projectinput1"> وصف المنتج
                                                                        -In {{$lang->title}}</label>
                                                                 <textarea id="editor1" class="form-control" name="category[{{$index}}][description]" ></textarea>
                                                            ...
                                                            <div class="col-md-6 hidden">
                                                                <div class="form-group">
                                                                    ...
                                                                    <input type="text" id="slogan" class="form-control"
                                                                           value=" {{$lang -> slogan}}"
                                                                           name="category[{{$index}}][slogan]">
                                                                    @error("category.$index.slogan")
                                                                    <span class="text-danger">{{$message}} </span>
                                                                    @enderror
                                                                </div>
                                                            </div>
