                ...
                <div class="row breadcrumbs-top">
                    <div class="breadcrumb-wrapper col-12">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active">تعديل تاجر
                            </li>
                        </ol>
                    </div>
                </div>
                                    ...
                                    <form class="form" action="{{route('admin.vendor.update',$vendor->id)}}" method="POST"
                                        ...
                                        <div class="form-group">
                                            <div class="text-center">
                                                <img src="{{$vendor->logo}}" class="rounded-circle height-150"
                                                     alt="صورة التاجر">
                                            </div>
                                        </div>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-6 ">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" id="email" value="{{$vendor->email}}"
                                                               class="form-control"
                                                ...
                                                <div class="class col-12">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="password" id="password"
                                                               class="form-control"
                                                               placeholder=" Enter password Please " name="password">
